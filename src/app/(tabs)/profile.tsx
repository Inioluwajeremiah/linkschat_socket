...
//   // Re-read the selection every time this screen regains focus, so coming
//   // back from the ringtone picker shows the newly chosen name immediately.
//   useFocusEffect(
//     useCallback(() => {
//       resolveRingtone().then((r) => setRingtoneName(r?.name || "Default"));
//     }, [])
//   );
