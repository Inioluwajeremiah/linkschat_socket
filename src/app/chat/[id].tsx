...
//     ? require("@/assets/images/linkschat_bg_dark2.png")
//     : require("@/assets/images/linkschat_bg_light2.png");
...
//           // ── Prefetch page 2 immediately in the background ──────────────
//           // This means by the time user scrolls up, page 2 is already loaded
//           if (
...
//   const PAGE_SIZE = 40;
//   const PREFETCH_THRESHOLD = 10; // fetch next page when 10 items from top
...
//           return;
//         }
//         // Prepend — user never sees a jump because FlatList is inverted
//         dispatch(setMessages({ chatId, messages: [...older, ...messages] }));
//         setHasMore(res.data.pagination.hasNextPage);
//         setCurrentPage(res.data.pagination.page);
//       }
...
//   // Reverse listData so newest is at index 0 (FlatList renders bottom-up when inverted)
//   const listData = useMemo(() => {
//     const data: ListItem[] = [];
...
//             inverted // ← newest at bottom, scrolls up to see older
//             viewabilityConfigCallbackPairs={viewabilityConfigCallbackPairs}
//             onEndReached={loadMore}
//             onEndReachedThreshold={0.25} // ← fires when 25% from the top (since inverted = top is old)
//             maintainVisibleContentPosition={{
//               minIndexForVisible: 1, // ← prevents scroll jump when prepending
//               autoscrollToTopThreshold: 10,
//             }}
//             ListFooterComponent={
//               // ← footer is visually at TOP because inverted
//               loadingMore ? (
//                 <ActivityIndicator color="#00d4aa" style={{ margin: 16 }} />
//               ) : null
//             }
//             ListHeaderComponent={
//               // ← header is visually at BOTTOM because inverted
...
//               // With inverted list, "previous" message is actually the next index
        ...
        >
          ...
          >
            <MaterialCommunityIcons
              name="sticker-emoji"
              size={24}
              color={showStickers ? "#00d4aa" : colors.textMuted}
            />
          </TouchableOpacity>
          <View
            style={[
